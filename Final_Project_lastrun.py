...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/palpatel/Desktop/Final_Project_lastrun.py',
...
polygon_2 = visual.ShapeStim(
    win=win, name='polygon_2', vertices='arrow',
    size=(0.05, 0.2),
...
trials = data.TrialHandler(nReps=100.0, method='random', 
    ...
    trialList=data.importConditions('final_conditions.xlsx'),
...
for thisTrial in trials:
    ...
    polygon_2.setOri(orient)
    grating.setOri(tilt)
    key_resp.keys = []
    key_resp.rt = []
    _key_resp_allKeys = []
    # keep track of which components have finished
    trialComponents = [polygon, polygon_2, grating, key_resp]
    ...
    while continueRoutine:
        ...
        if key_resp.status == NOT_STARTED and tThisFlip >= 1.8-frameTolerance:
            # keep track of start time/frame for later
